...
function quantserve(){
 ...
 var d=new Date();
 var dst=_qcdst();
 var dg="P8768-M-Sa-u";var qs="http://pixel.quantserve.com";
 var fp=_qcsc(media);
 ...
 _qimg=new Image();
 _qimg.alt="";
 _qimg.src=parseURL(qs+'/pixel'+';r='+r+fp+';ns='+ns+';url='+url+';ref='+ref+';ce='+ce+';je='+je+';sr='+sr+';dg='+dg+';dst='+dst+';et='+d.getTime()+';tzo='+d.getTimezoneOffset()+';a='+_qacct+qo+qm);
